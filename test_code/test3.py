...
def date_diff(date1, date2):
    ...
    if year1 == year2: return abs(days_count1 - days_count2) + 1
        ...
        for year in range(year1 + 1, year2): days_between_years += days_in_year(year)
        days_between_years += days_count2
        return days_between_years + 1

dates = input("Enter two dates in the format (DD-MM-YYYY, DD-MM-YYYY): ")
date_input1, date_input2 = map(str.strip, dates.split())
print(date_diff(date_input1, date_input2))